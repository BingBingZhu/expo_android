...
public class CameraManager1 {
    ...
    private CameraManager1 mInstance;
    ...
    public CameraManager1(View displayView) {
        if (displayView == null)
    ...
    private void changeDisplayViewSize(Camera.Size previewSize) {
        ...
        if (mViewHeight != height) {
            mViewHeight = height;
            RelativeLayout.LayoutParams lp = (RelativeLayout.LayoutParams) mDisplayView.getLayoutParams();
