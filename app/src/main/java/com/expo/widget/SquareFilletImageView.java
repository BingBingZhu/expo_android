...
public class SquareFilletImageView extends AppCompatImageView {
    ...
    public SquareFilletImageView(Context context) {
        this(context, null);
    }

    public SquareFilletImageView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public SquareFilletImageView(Context context, AttributeSet attrs, int defStyle) {
