...
import com.expo.module.online.scene.SceneFragment;

import java.util.List;

public class CultureTabPagerAdapter extends FragmentStatePagerAdapter {

    private List<FindTab> tabs;
    private Bundle bundle;

    public CultureTabPagerAdapter(FragmentManager fm) {
        super(fm);
    }
