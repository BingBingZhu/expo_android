...
public class ShareUtil {
    ...
    public static void showShare(Context context, String title, String text, String imageUrl, String shareUrl, PlatformActionListener listener, boolean isOnlyImg) {
