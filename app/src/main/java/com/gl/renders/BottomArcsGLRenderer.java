...
public class BottomArcsGLRenderer implements GLTextureView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void setCornerRadiusAndArrow(float radius) {
    ...
    public void onSurfaceChanged(GL10 glUnused, int width, int height) {
        ...
        if (surfaceListener != null) {
            surfaceListener.onSurfaceChanged( surfaceTexture, width, height );
        }
        updateVertexData();
    }
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        GLES20.glFinish();
        if (surfaceListener != null) {
            surfaceListener.onSurfaceUpdate( surfaceTexture );
        }
    }
